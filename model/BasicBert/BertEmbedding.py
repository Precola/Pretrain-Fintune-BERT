...
class BertEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.dropout = nn.Dropout(0)   #config.hidden_dropout_prob
    ...
    def forward(self,
                ...
                token_type_ids=None):
        """
        :param input_ids: token id, shape: [src_len, batch_size]
        :param position_ids:  [0,1,2,3,...,src_len-1], shape: [1,src_len]
        :param token_type_ids: for NSP two sentences [0,0,0,0,1,1,1,1] shape:[src_len,batch_size]
